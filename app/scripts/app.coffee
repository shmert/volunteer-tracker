...
angular
  ...
  .config ($routeProvider, $httpProvider) ->
    ...
    $routeProvider
      .when '/',
        templateUrl: 'views/main.html?v=2017-01-19'
        controller: 'MainCtrl'
        resolve:{
          myJobs:(jobService)->jobService.myJobs()
        }
      .when '/about',
        templateUrl: 'views/about.html?v=2017-01-19'
        controller: 'AboutCtrl'
      .when '/job-detail/:id',
        templateUrl: 'views/job-detail.html?v=2017-01-19'
      ...
      .when '/job-signup-report/:id',
        templateUrl: 'views/job-signup-report.html?v=2017-01-19'
      ...
      .when '/job-list',
        templateUrl: 'views/job-list.html?v=2017-01-19'
        controller: 'JobListCtrl'
        reloadOnSearch: false
      .when '/job-add',
        templateUrl: 'views/job-admin.html?v=2017-01-19'
      ...
      .when '/admin',
        templateUrl: 'views/admin.html?v=2017-01-19'
        controller: 'AdminCtrl'
      .when '/admin/users',
        templateUrl: 'views/admin-users.html?v=2017-01-19'
      ...
      .when '/about',
        ...
        controller: 'AboutCtrl'
      .when '/ssb',
        templateUrl: 'views/ssb.html?v=2017-01-19'
        controller: 'SsbCtrl'
      .when '/admin/addIndividualTime',
        templateUrl: 'views/admin-addindividualtime.html?v=2017-01-19'
      ...
      .when '/admin/signups',
        templateUrl: 'views/admin-signups.html?v=2017-01-19'
        controller: 'AdminSignupsCtrl'
      .when '/about',
        templateUrl: 'views/about.html?v=2017-01-19'
        controller: 'AboutCtrl'
      .when '/not-logged-in',
        templateUrl: 'views/not-logged-in.html?v=2017-01-19'
        controller: 'NotLoggedInCtrl'
      .when '/admin/users/:id',
        templateUrl: 'views/admin-user-edit.html?v=2017-01-19'
        controller: 'AdminUserEditCtrl'
        resolve: {
          user: ($route, userService) -> userService.findById($route.current.params.id)
        }
      .when '/bug-report',
        templateUrl: 'views/bug-report.html?v=2017-01-19'
        controller: 'BugReportCtrl'
        controllerAs: 'bugReport'
      .when '/admin/groups',
        templateUrl: 'views/groups.html?v=2017-01-19'
      ...
      .when '/admin/groups/:id',
        templateUrl: 'views/groups-detail.html?v=2017-01-19'
      ...
      .when '/signup-list',
        templateUrl: 'views/signup-list.html?v=2017-01-19'
        controller: 'SignupListCtrl'
        controllerAs: 'signupList'
      .when '/profile-edit',
        templateUrl: 'views/profile-edit.html?v=2017-01-19'
        controller: 'ProfileEditCtrl'
        controllerAs: 'profileEdit'
      .when '/admin/volunteer-roundup',
        templateUrl: 'views/admin-volunteer-roundup.html?v=2017-01-19'
